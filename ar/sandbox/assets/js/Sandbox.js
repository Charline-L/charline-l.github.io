class Sandboxe {
    ...
    createLight() {
        ...
        t.directionalLight.shadow.camera.bottom = -3
        t.directionalLight.shadow.camera.top = 3
        t.directionalLight.shadow.camera.right = 3
        t.directionalLight.shadow.camera.left = -3
