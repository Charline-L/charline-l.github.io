class Sandboxe {
    ...
    createLight() {
        ...
        t.directionalLight.shadow.camera.bottom = -1 - 0.6
        t.directionalLight.shadow.camera.top = 1 + 0.6
        t.directionalLight.shadow.camera.right = 1 + 0.6
        t.directionalLight.shadow.camera.left = -1 - 0.6
