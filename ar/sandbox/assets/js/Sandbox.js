class Sandboxe {
    ...
    createLight() {
        ...
        t.directionalLight.shadow.camera.bottom = -6
        t.directionalLight.shadow.camera.top = 6
        t.directionalLight.shadow.camera.right = 6
        t.directionalLight.shadow.camera.left = -6
